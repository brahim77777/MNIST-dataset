...
images = x_train[0:6000].reshape(6000, 28*28)/255

labels = y_train[0:6000]
...
one_hot_labels_test = np.zeros((len(x_test), 10))
...
for x in range(len(x_test)):
    layer_0_values = x_test[x:x+1] # 
    layer_1_values = np.dot() 
